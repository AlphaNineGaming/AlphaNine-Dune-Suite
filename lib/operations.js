...
function operationsConflict(leftKey, rightKey) {
  ...
  if (left === "repair:database-ownership" || right === "repair:database-ownership") {
    const otherClass = left === "repair:database-ownership" ? rightClass : leftClass;
    if (otherClass === "server-control") return true;
  }
