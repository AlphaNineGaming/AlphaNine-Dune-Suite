...
dw.VehicleDurabilityDamageMultiplier={max(0, min(10, float(setting(profile, "environment", "stormSeverity", 1)))):.2f}
...
Vehicle.SandwormInvulnerabilitySecondsOnExit={max(0, float(setting(profile, "environment", "waterRetentionMultiplier", 1)) * 900):.1f}
