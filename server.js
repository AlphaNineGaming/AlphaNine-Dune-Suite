...
function filterItemsByQuery(items = [], searchParams = new URLSearchParams()) {
  ...
  const category = /^(all|\*)$/i.test(rawCategory) ? "" : normalizeItemCategory(rawCategory);
      ...
      <div class="settings-grid">
        ...
        <div class="panel pad advanced-only">
          ...
          <div class="detail-list">
            ...
            <div class="detail-row"><span class="subtle">Web Portal</span><strong id="settingsWebPortalUrl">${portalUrls[0]}</strong></div>
